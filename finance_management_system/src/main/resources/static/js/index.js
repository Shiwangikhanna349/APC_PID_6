...
async function handleAddUser(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall('/user/add', {
            method: 'POST',
...
async function handleEditUser(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/user/edit/${userId}`, {
            method: 'PUT',
            body: JSON.stringify(formData)
        });
...
async function deleteUser(userId) {
    if (confirm('Are you sure you want to delete this user?')) {
        try {
            showLoading(true);
            const result = await apiCall(`/user/delete/${userId}`, {
                method: 'DELETE'
            });
...
async function handleAddTransaction(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall('/transaction/add', {
            method: 'POST',
            body: JSON.stringify(formData)
        });
...
async function handleUserTransactions(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/transaction/user/${userId}`);
...
async function handleEditTransaction(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/transaction/edit/${transactionId}`, {
            method: 'PUT',
            body: JSON.stringify(formData)
        });
...
async function editTransaction(transactionId) {
    try {
        showLoading(true);
        const result = await apiCall(`/transaction/all`);
...
async function deleteTransaction(transactionId) {
    if (confirm('Are you sure you want to delete this transaction?')) {
        try {
            showLoading(true);
            const result = await apiCall(`/transaction/delete/${transactionId}`, {
                method: 'DELETE'
            });
...
async function handleUserReport(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/reports/balance?userId=${userId}`);
...
async function handleMonthlyReport(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/reports/monthly?userId=${userId}&year=${year}&month=${month}`);
...
async function handleWeeklyReport(e) {
    ...
    try {
        showLoading(true);
        const result = await apiCall(`/reports/weekly?userId=${userId}&year=${year}&month=${month}&week=${week}`);
...
async function loadUsers() {
    try {
        showLoading(true);
        const result = await apiCall('/user/all');
